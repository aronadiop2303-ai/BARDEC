...
const AI_RESPONSES: Record<string, string> = {
  ...
  defaut: `Bonne question ! Voici ce que je peux vous dire à partir des données BARDEC :\n\n**Points clés à considérer :**\n• Vérifiez la disponibilité du produit chez plusieurs fournisseurs BARDEC certifiés\n• Comparez les délais de livraison et les conditions MOQ avant de valider\n• Pour les achats B2B > $5 000, activez la Trade Assurance pour une protection maximale\n• Les produits notés 4.5⭐ et plus ont un taux de litige inférieur à 2%\n\n**Prochaine étape recommandée :**\nUtilisez la recherche avancée (onglet Recherche) pour filtrer par certification, pays d'origine et fourchette de prix — vous trouverez les meilleurs fournisseurs pour votre besoin spécifique.\n\nSi votre question concerne une commande précise, partagez le numéro BDC et je l'analyserai immédiatement.`,
};
